      ...
      <section id="articles" className="py-20 px-6 bg-gray-800/50">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-900/50 rounded-xl border border-gray-700 p-8">
              <div className="substack-post-embed">
                <p lang="en">Playing Safe with Ransomware: A Pen Tester's View on How Nigerian Businesses Can Build Tough Defenses by Sentinel Link</p>
                <p></p>
                <a data-post-link href="https://sentinellink.substack.com/p/playing-safe-with-ransomware-a-pen">Read on Substack</a>
              </div>
              <script async src="https://substack.com/embedjs/embed.js" charset="utf-8"></script>
            </div>
          </div>
