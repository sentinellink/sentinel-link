...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white">
      ...
      <nav className="container mx-auto px-6 py-4 sticky top-0 bg-gray-900/90 backdrop-blur-sm z-50">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6">
            <a href="#services" className="hover:text-blue-400 transition" onClick={(e) => { e.preventDefault(); scrollToSection('services'); }}>Services</a>
            <a href="#objectives" className="hover:text-blue-400 transition" onClick={(e) => { e.preventDefault(); scrollToSection('objectives'); }}>Objectives</a>
            <a href="#benefits" className="hover:text-blue-400 transition" onClick={(e) => { e.preventDefault(); scrollToSection('benefits'); }}>Benefits</a>
            <a href="#why-us" className="hover:text-blue-400 transition" onClick={(e) => { e.preventDefault(); scrollToSection('why-us'); }}>Why Us</a>
            <a href="#resources" className="hover:text-blue-400 transition" onClick={handleBlogClick}>Resources</a>
            <a href="#contact" className="hover:text-blue-400 transition" onClick={(e) => { e.preventDefault(); scrollToSection('contact'); }}>Contact</a>
          </div>
        ...
        <div className={`md:hidden ${isMenuOpen ? 'block' : 'hidden'} mt-4 pb-4`} aria-label="Mobile navigation">
          <div className="flex flex-col space-y-3">
            <a href="#services" className="hover:text-blue-400 transition py-2" onClick={(e) => { e.preventDefault(); scrollToSection('services'); }}>Services</a>
            <a href="#objectives" className="hover:text-blue-400 transition py-2" onClick={(e) => { e.preventDefault(); scrollToSection('objectives'); }}>Objectives</a>
            <a href="#benefits" className="hover:text-blue-400 transition py-2" onClick={(e) => { e.preventDefault(); scrollToSection('benefits'); }}>Benefits</a>
            <a href="#why-us" className="hover:text-blue-400 transition py-2" onClick={(e) => { e.preventDefault(); scrollToSection('why-us'); }}>Why Us</a>
            <a href="#resources" className="hover:text-blue-400 transition py-2" onClick={handleBlogClick}>Resources</a>
            <a href="#contact" className="hover:text-blue-400 transition py-2" onClick={(e) => { e.preventDefault(); scrollToSection('contact'); }}>Contact</a>
          </div>
        </div>
      </nav>
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  ...
                  onClick={(e) => { e.preventDefault(); scrollToSection('investment'); }}
                >
                  Request Security Assessment
                </a>
                <a href="#services" className="border border-blue-500 text-blue-400 hover:bg-blue-900/30 font-medium py-3 px-6 rounded-lg transition text-center" onClick={(e) => { e.preventDefault(); scrollToSection('services'); }}>
                  Learn More
                </a>
              </div>
            </div>
      ...
      <section id="resources" className="py-20 px-6 bg-gray-800/50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Security Resources</h2>
            <div className="w-20 h-1 bg-blue-500 mx-auto"></div>
            <p className="mt-4 text-gray-400 max-w-2xl mx-auto">
              Free resources to help you understand and improve your security posture
            </p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-900/50 rounded-xl border border-gray-700 overflow-hidden hover:border-blue-500 transition transform hover:-translate-y-1">
            ...
            <div className="bg-gray-900/50 rounded-xl border border-gray-700 overflow-hidden hover:border-blue-500 transition transform hover:-translate-y-1">
              ...
              <div className="p-6">
                ...
                <a href="https://sentinellink.substack.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 font-medium inline-flex items-center">
                  Read More
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                  </svg>
